...
<body>
    <div class="app-container">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <div class="nav">
                <div class="nav-title">
                    <span>Каналы</span>
                    <button class="add-btn" onclick="createChannel()">
                        <i class="fas fa-plus"></i>
                    </button>
                </div>
                <div id="channels">
                    <div class="nav-item active" onclick="joinRoom('general')">
    ...
    <script>
        ...
        function createChannel() {{
            ...
            if (name) {{
                // Здесь будет логика создания канала
...
if __name__ == '__main__':
    ...
    socketio.run(app, host='0.0.0.0', port=port, debug=False)# web_messenger.py - Tandau Messenger
